export default {
  ...
  intro: {
    ...
    toAddPlayers: "to add more players. You can also join a game session by pressing",
    toJoinSession: ".",
    footer: "This project is free and open source and can be found on GitHub. It is not affiliated with The Pandemonium Institute. \"Blood on the Clocktower\" is a trademark of Steven Medway and The Pandemonium Institute.",
