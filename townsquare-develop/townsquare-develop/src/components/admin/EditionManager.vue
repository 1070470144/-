    ...
    <div class="edition-list">
      ...
      >
        <div class="edition-info">
          ...
          <p class="edition-type" :class="{ 'official': edition.isOfficial, 'custom': !edition.isOfficial }">
    ...
    <div v-if="showAddEdition || editingEdition" class="edition-modal">
      <div class="modal-content">
        ...
        <div class="form-group">
          <label>剧本名称:</label>
          <input v-model="editionForm.name" placeholder="剧本显示名称" @input="generateId" />
        </div>
              ...
              <div class="category">
                ...
                <div class="role-list">
                  <label v-for="role in townsfolkRoles" :key="role.id" class="role-item">
                    <input type="checkbox" v-model="editionForm.roles" :value="role.id" />
                    <span>{{ role.name }}</span>
                  </label>
                </div>
              </div>
...
export default {
  ...
  methods: {
    editEdition(edition) {
      // 检查是否为默认剧本
      const isDefaultEdition = defaultEditions.some(defaultEdition => defaultEdition.id === edition.id);
    ...
    saveEdition() {
      ...
      // 检查是否为默认剧本
      const isDefaultEdition = defaultEditions.some(edition => edition.id === this.editionForm.id);
